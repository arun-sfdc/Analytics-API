...
app.get('/', function(req, res) {
		var METRICS = [ { reportid : '', username : '', password : '', loginurl: 'https://na1.salesforce.com', chart: 'pie' }, // chart = pie, bar or table
				{ reportid : '', username : '', password : '!j', loginurl: 'https://na1.salesforce.com', chart: 'table' } ];
		function getReportResults(metric, callback) {
				var conn = new jsforce.Connection({ loginUrl: metric.loginurl });
